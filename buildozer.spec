...
package.domain = org.kesodev

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,kv,ico
...
requirements = python3,kivy,kivymd,math
...
icon.filename = %(source.dir)s/SGN_10_25_2023_1698219205385.ico
